...
The entity type system that {{site.data.keyword.nlushort}} uses differs based on which language you use. For more details, see the [Entity types systems](/docs/services/natural-language-understanding-data?topic=natural-language-understanding-data-entity-type-systems) page.
